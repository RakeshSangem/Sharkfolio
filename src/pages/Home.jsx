      ...
      <section className="w-[80vw] h-full">
        <div className="flex flex-col items-center justify-between min-h-[42vh]">
          <div className="text-center drop-shadow-lg">
            <h3
              className="text-5xl font-semibold opacity-0 -translate-x-20"
              ref={welcome}
            >
              Welcome to
            </h3>
            <h1
              className="bg-gradient-to-b from-[#8DFBFF] to-[#308EC7] bg-clip-text text-8xl font-bold text-transparent -translate-x-20 opacity-0"
              ref={shark}
            >
              Shark World
            </h1>
          ...
          <p
            className="text-md text-teal-200/50 font-light text-center w-1/2 opacity-0 -translate-x-20"
            ref={paragraph}
          >
