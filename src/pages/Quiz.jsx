...
export default function Quiz() {
   return(
      <main className="bg-normal bg-no-repeat bg-cover w-full flex items-center justify-center min-h-screen text-white relative">
         <Navbar />
         <div className="flex flex-col h-full w-[50vw] rounded-3xl items-center justify-between bg-gradient-to-t from-[#07394B]/40 to-[#091B24]/30 border-[#6EE9FF] border-2 bg-[#064550]/40 mt-8 ">
            ...
            <h2 className="text-3xl text-[#70D9FF] py-12 font-semibold tracking-wide">Does shark eat biryani or pineapple pizza? </h2>
