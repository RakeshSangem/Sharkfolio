...
export default function Quiz() {
   return(
      <main className="w-full flex bg-[url('../public/bg-ocean.png')] items-center justify-center min-h-screen text-white relative">
         <Navbar />
         <div className="flex flex-col h-full w-[60vw] rounded-3xl items-center justify-between bg-gradient-to-t from-[#07394B]/40 to-[#091B24]/30 border-[#6EE9FF] border-2 bg-[#064550]/40 mt-8 ">
